// Generated from the curated Wordle answers list (common words only).
// Used to pick the secret word in single-player mode.
#include "wordlist.h"

const char answerlist[][6] = {
...
const int answerlist_count = 2315;
